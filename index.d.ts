...
declare class DynamicConfig {
    ...
    get(key: (string | string[]) = undefined, defaultValue: any = null, throwOnDefault: boolean = false): any;
    getAsString(key: (string | string[]) = undefined, defaultValue: any = null, throwOnDefault: boolean = false): string;
    getAsInt(key: (string | string[]) = undefined, defaultValue: any = null, throwOnDefault: boolean = false): number;
    getAsFloat(key: (string | string[]) = undefined, defaultValue: any = null, throwOnDefault: boolean = false): number;
    getAsBoolean(key: (string | string[]) = undefined, defaultValue: any = null, throwOnDefault: boolean = false): boolean;
